...
urlpatterns = [
    ...
    url(r'^invoices/received/$', staff_member_required(TemplateView.as_view(template_name='spa.html')), name='invoices-received'),
    url(r'^invoices/sent/$', staff_member_required(TemplateView.as_view(template_name='spa.html')), name='invoices-sent'),
    ...
    url(r'^invoices/(?P<invoice_id>[-\w\d]+)/payment/$', staff_member_required(TemplateView.as_view(template_name='spa.html')), name='invoice-payment'),
    url(r'^invoices/(?P<invoice_id>[-\w\d]+)/payment/review/$', staff_member_required(TemplateView.as_view(template_name='spa.html')), name='invoice-payment'),
    url(r'^invoices/(?P<invoice_id>[-\w\d]+)/payment/confirmation/$', staff_member_required(TemplateView.as_view(template_name='spa.html')), name='invoice-payment'),
