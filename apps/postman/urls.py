...
from . import OPTIONS
from postman.views import (InboxView, SentView, ArchivesView, BookmarksView, TrashView,
        WriteView, ReplyView, MessageView, ConversationView,
        ArchiveView, UnarchiveView, DeleteView, UndeleteView, BookmarkView, UnbookmarkView)
...
urlpatterns = patterns('',
    ...
    url(r'^important/(?:(?P<option>'+OPTIONS+')/)?$', BookmarksView.as_view(), name='bookmarks'),
