...
import { Input, DateInput, Select, Textarea, RadioGroup, WYSIWYG } from '../../SPAcomponents/input';
import Button from '../../SPAcomponents/button';
import { InputError, ApiError } from '../../SPAcomponents/errors';
  ...
  render() {
    ...
    return (
      <div className="newProject-basics">
        ...
        {formErrorMessage}
        {apiErrorMessage}
        <Button className="newProject-button--proceed" pretty={true} size="large" onClick={this.submitBasics} isLoading={isSending} disabled={isLoading || isSending || formError}>Save Project &amp; Continue</Button>
      </div>
    );
  }
}));
  ...
  render() {
    ...
    return (
      <div className="newProject-details">
        ...
        {formErrorMessage}
        {apiErrorMessage}
        <Button className="newProject-button--proceed" pretty={true} size="large" onClick={this.submitDetails} isLoading={isSending} disabled={isLoading || isSending || formError}>Save Project &amp; Continue</Button>
  ...
  render() {
    ...
    return (
      <div className="newProject-details">
        ...
        {formErrorMessage}
        {apiErrorMessage}
        <Button className="newProject-button--proceed" pretty={true} size="large" onClick={this.submitBudget} isLoading={isSending} disabled={isLoading || isSending || formError}>Post Project</Button>
      </div>
    );
  }
}));
