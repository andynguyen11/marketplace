...
import { MultipleAttachmentsPreview } from './AttachmentField'
            ...
            <div className="row">
                <div className="container">
                    <h2 className="section-header text-center sub-section">
                        { title } <br />
                        <span className="text-yellow">by { _company_name ? _company_name : _project_manager_name }</span>
                    </h2>
                        ...
                        <div className="sub-section">
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="project-byline pull-left">
                                    <p>
                                        <span className="project-manager">{ _project_manager_name }</span> <br />
