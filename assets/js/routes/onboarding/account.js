      ...
      <div className='base-form' >
        ...
        <div className='col-md-4 col-md-offset-3'>
            <div className={ 'form-group ' + formElements.profileFirstName.errorClass }>
                <label id={formElements.profileFirstName.name} className="control-label" htmlFor={formElements.profileFirstName.name}>{formElements.profileFirstName.label}</label>
                <input
                    className={ 'form-control ' + formElements.profileFirstName.errorClass }
                    type='text'
            ...
            <div className={ 'form-group ' + formElements.profileLastName.errorClass }>
                <label className="control-label" htmlFor={formElements.profileLastName.name}>{formElements.profileLastName.label}</label>
                <input
                    className={ 'form-control ' + formElements.profileLastName.errorClass }
                    type='text'
        ...
        <div className='col-md-4 col-md-offset-3'>
          ...
          { formElements.profileCountry.value == 'United States of America' ?
            <select className={ 'form-control ' + formElements.profileStateProvince.errorClass } value={formElements.profileStateProvince.value} name={formElements.profileStateProvince.name} id={formElements.profileStateProvince.name} onChange={handleChange} >
            ...
            :
            <input
              className={ 'form-control ' + formElements.profileStateProvince.errorClass }
              type='text'
        ...
        <div className={'form-group col-md-6 col-md-offset-3 ' + formElements.profileBio.errorClass }>
