...
const ContractBuilder = React.createClass({
  ...
  render() {
    const { formElements, formError, formErrorsList, handleChange, terms, saveTerms, convertFromMomentToStartDate, convertFromMomentToEndDate } = this.props;
            ...
            <div className="sub-section">
              ...
              <div className='col-md-12'>
                <div className={ 'form-group ' + formElements.deliverables.errorClass }>
                  ...
                  <p className="text-muted small">
                    This is where you should list your expected deliverables, along with any specifics about each
                    deliverable (i.e.
                    file formats, code languages, delivery instructions, etc). Be as detailes as possible to ensure you
                    and the
              ...
              <div className='col-md-12'>
                <div className={ 'form-group ' + formElements.milestones.errorClass }>
                  ...
                  <p className="text-muted small">
                    List all project milestones here, such as reviews and delivery dates. Be sure to include the dates
                    next to
                    each milestone.
                  </p>
                  <textarea
